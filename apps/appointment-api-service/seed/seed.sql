...
INSERT INTO "appointments" ("id", "tenant_id", "customer_id", "vehicle_id", "service_type_id", "technician_id", "service_bay_id", "start_time", "end_time", "status", "created_at", "updated_at")
VALUES
